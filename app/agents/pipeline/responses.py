...
_ESCALATION_SYSTEM = (
    ...
    "  2. Recommends they raise a support ticket so the IT team can investigate directly.\n"
    "     IMPORTANT: Do NOT say you are escalating or contacting anyone. "
    "     You are providing a link for the USER to raise the ticket themselves.\n"
    "     Use phrasing like: 'I recommend raising a support ticket' or "
    "     'the best next step is to raise a support ticket with the IT team'\n"
