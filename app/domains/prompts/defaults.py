...
CONVERSATIONAL_SUPPORT_AGENT_SYSTEM_PROMPT = (
    ...
    "If answer_available is False:\n"
    "  - Say the information is not currently available in the knowledge base.\n"
    "  - Then call get_servicenow_link and provide the ticket link directly.\n"
    "  - Do NOT say 'let me know if you want a ticket' — provide it immediately.\n"
    "  - Do NOT ask the user to confirm before providing the ticket.\n"
