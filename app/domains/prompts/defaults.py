...
CONVERSATIONAL_SUPPORT_AGENT_SYSTEM_PROMPT = (
    ...
    "```\n\n"
    "For HOW-TO / GUIDANCE responses (user asks HOW to do something — no error, no problem):\n"
    "Detect HOW-TO by these signals: message starts with \'how do I\', \'how to\', "
               "\'what is\', \'can I\', \'where do I\', or asks for steps/process/guidance.\n"
    "```\n"
    ...
    "```\n"
    "STRICTLY FORBIDDEN in how-to responses:\n"
    "  - \'Steps to resolve\' — use \'Here\'s how to [action]\' instead\n"
    "  - \'If these steps do not resolve your issue\' — use \'Let me know if you need help\'\n"
    "  - Any use of the words: issue, problem, resolve, fix, broken, error (unless quoting source)\n\n"
